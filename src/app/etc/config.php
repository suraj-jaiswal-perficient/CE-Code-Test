...
return [
     ...
     * CONFIG__DEFAULT__TWOFACTORAUTH__DUO__INTEGRATION_KEY for twofactorauth/duo/integration_key
     * CONFIG__DEFAULT__TWOFACTORAUTH__DUO__SECRET_KEY for twofactorauth/duo/secret_key
     * CONFIG__DEFAULT__TWOFACTORAUTH__DUO__API_HOSTNAME for twofactorauth/duo/api_hostname
     * CONFIG__DEFAULT__TWOFACTORAUTH__AUTHY__API_KEY for twofactorauth/authy/api_key
        ...
        'default' => [
            'payment' => [
                ...
                'braintree_paypal' => [
                    ...
                    'button_paylater_cart_enable' => null,
                    'message_cart_enable' => null,
                    ...
                    'button_productpage_enabled' => null,
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'twofactorauth' => [
                'general' => [
                    ...
                    'webapi_notification_url' => null,
                ],
                'google' => [
                    'otp_window' => '1',
                ],
                'duo' => [
                    'application_key' => '06JdHcg2AWBz9KEPpvXxn3rTRV301afhwf19b7WUH6WrupxhQPtZdjTYFp6tqYPx',
                ],
                'authy' => [
                    'onetouch_message' => 'Login request to your Magento Admin',
                ],
                'u2fkey' => [
                    'webapi_challenge_domain' => null,
                ],
            ],
